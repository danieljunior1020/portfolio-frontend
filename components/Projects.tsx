...
function Projects({}: Props) {
  ...
  return (
    ...
    text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0'>
             ...
             {projects.map((project, i) => (
                ...
                p-20 md:p-44 h-screen'>
                    <motion.img
                     ...
                     viewport={{ once: true }}
                    src="https://slawkolodziej.com/static/5fb4db89d9e7bdc98e271d7586f8719b/2cefc/1.png" 
                    alt="" />
                    ...
                    <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                        ...
                        <p>
                        When you just start learning front-end development it's important to consolidate
                         your knowledge about HTML and CSS. Building a Blog Template is a good idea for your 
                        first bigger project. Do not worry about design, there are many resources 
                        </p>
                    </div>
                </div>
             ))}
        ...
        <div className='w-full absolute top-[30%] bg-[#969654]/80
